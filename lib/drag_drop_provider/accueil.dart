...
class AccueilDraggableProvider extends StatefulWidget {
  static const routeName="/accueil-draggable";

  @override
  _AccueilDraggableProviderState createState() => _AccueilDraggableProviderState();
}

class _AccueilDraggableProviderState extends State<AccueilDraggableProvider> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      //floatingActionButtonLocation: FloatingActionButton(onPressed: null),
      appBar: AppBar(
        title: Text("myApp"),
        centerTitle: true,
